...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 3iv-r6L82e0/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 1eRs152dgfn/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 6WI_anV_EPs/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cEkZg)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___0IXa6)}
                role={"img"}
              />
            ),
