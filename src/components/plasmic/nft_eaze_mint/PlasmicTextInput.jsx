...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: Uc6NxlbWQx2/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: XUuLxivtjOv/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 1eRs152dgfn/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__j0Z0)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cgkFf)}
                role={"img"}
              />
            ),
